...
def on_starting(server):
    ...
    from api.schedules import status_worker, status_farm, status_plotting, \
        ...
        stats_effort, status_warnings, status_archiving, status_plot_health
    ...
    if utils.is_fullnode():
        ...
        scheduler.add_job(func=status_plot_health.update, name="status_plot_health", trigger='interval', minutes=15, jitter=JOB_JITTER) # Every 15 minutes
